            ...
            return isEntitled ? (
              <StackItem key={key} className="rbac-c-mua-cardWrapper">
                <NavLink
                  ...
                  className={classNames('rbac-c-mua-bundles__cardlink', { 'pf-v6-u-background-color-disabled-color-300': isDisabled })}
                ...
                >
                  ...
                  >
                    <CardTitle className="pf-v6-u-font-weight-light"> {data.title}</CardTitle>
                    <CardBody>
